...
En esta sección se recoge la documentación orientada al usuario final del programa, proporcionando 
la información necesaria para comprender, instalar y operar correctamente \textbf{ESI-Escape}. Se abordan 
tanto sus funcionalidades principales como los procedimientos de instalación, 
acceso al sistema y uso de la interfaz de juego.
...
\begin{itemize}
  ...
  pistas que el propio juego proporciona. La ubicación de los puzles, su solución y la conexión que desbloquean se declaran
...
\begin{figure}[h!]
\centering
\includegraphics[width=1\textwidth]{gameFlow.png}
\caption{Esquema del flujo general del programa ESI-Escape.}
\label{fig:gameflow}
\end{figure}
...
\caption{Mapa de juego incluido en la entrega del proyecto.}
\label{fig:map}
\end{figure}
