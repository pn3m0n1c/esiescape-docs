...
\begin{itemize}
	...
	\item Git: Usado para la administración de los archivos del proyecto, control de versión, y compartido de archivos para trabajo en equipo.
	\item Visual Studio Code: Editor de código con integración de Git para ver los cambios realizados y resolver conflictos donde varios miembros del equipo suban modificaciones que colisionen una con la otra.
	\item Librerías: Se usan las librerías del estándar ANSI C, las cuales son empleadas para constituir módulos que realizan las distintas tareas que requiere el proyecto.
