...
\includeonly{Portada1, Introduc, DocUsuario, DocSistema, DocCode, Referencias}
...
\usepackage[font={small,color=gray}, labelfont=bf]{caption}
...
% Cabecera: "GII - Metodología de la Programación" arriba a la derecha
\fancyhead[R]{\textcolor{gray!60}{\small GII -- Metodología de la Programación}}
\fancyhead[L]{}

% Pie: "ESI-Escape docs" a la izquierda, número al centro, "Universidad de Cádiz" a la derecha
\fancyfoot[L]{\textcolor{gray!60}{\small Documentación ESI-Escape}}
\fancyfoot[C]{\textcolor{gray!60}{\thepage}}
\fancyfoot[R]{\textcolor{gray!60}{\small Universidad de Cádiz}}
